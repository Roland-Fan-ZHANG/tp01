...
public class DOMNodeTest {
  ...
  public class Q1 {
    ...
    @Test
    public void nodeIsAttachedToTheDocument() {
      var document = new DOMDocument();
      var documentRef = new WeakReference<>(document);
      var node = document.createElement("node");
      document = null;
      System.gc();
      // the document should not be GCed because node references it
      assertFalse(documentRef.refersTo(null));
      Reference.reachabilityFence(node);
    }

    @Test
    public void createElementPrecondition() {
      var document = new DOMDocument();
    ...
    public void implementationHasPublicConstructors() {
      var node = new DOMDocument().createElement("foo");
  ...
  public class Q2 {
    ...
    public void createElementWithAttributesPreconditions() {
      var document = new DOMDocument();
      assertAll(
          () -> assertThrows(NullPointerException.class, () -> document.createElement("div", null)),
  ...
  public class Q3 {
    @Test
    public void createElementWithNoAttributes() {
      var document = new DOMDocument();
    ...
    @Test
    public void createElementWithAStringAttribute() {
      var document = new DOMDocument();
    ...
    @Test
    public void createElementWithAnIntegerAttribute() {
      var document = new DOMDocument();
    ...
    @Test
    public void createElementWithSeveralAttributes() {
      var document = new DOMDocument();
    ...
    @Test
    public void createElementWithSeveralAttributes2() {
      var document = new DOMDocument();
  ...
  public class Q5 {
    ...
    public void childrenIsUnmodifiable() {
      ...
      var child = document.createElement("bar");
      parent.appendChild(child);
      var node = document.createElement("baz");
    ...
    public void appendChildDifferentDocuments() {
      var parent = new DOMDocument().createElement("foo");
      var child = new DOMDocument().createElement("bar");
